...
public class RectangleOverlap {
	...
	public static boolean overlap(Rect rect1, Rect rect2) {
		...
		int rect1LeftTopY = Math.max(rect1.leftTop.x, rect1.rightBottom.x);
		int rect1rightBottomX = Math.max(rect1.leftTop.x, rect1.rightBottom.x);
		int rect1rightBottomY = Math.min(rect1.leftTop.x, rect1.rightBottom.x);

		int rect2LeftTopX = Math.min(rect2.leftTop.x, rect2.rightBottom.x);
		int rect2LeftTopY = Math.max(rect2.leftTop.x, rect2.rightBottom.x);
		int rect2rightBottomX = Math.max(rect2.leftTop.x, rect2.rightBottom.x);
		int rect2rightBottomY = Math.min(rect2.leftTop.x, rect2.rightBottom.x);
